...
describe('WalkthroughPanel', () => {
  ...
  it('should render guide walkthrough', () => {
    renderWithProvider(
      <WalkthroughPanel walkthroughType="guide" onClose={mockOnClose} />
    );
  ...
  it('should render study walkthrough', () => {
    renderWithProvider(
      <WalkthroughPanel walkthroughType="study" onClose={mockOnClose} />
    );
  ...
  it('should render session walkthrough', () => {
    renderWithProvider(
      <WalkthroughPanel walkthroughType="session" onClose={mockOnClose} />
    );
  ...
  it('should render timer walkthrough', () => {
    renderWithProvider(
      <WalkthroughPanel walkthroughType="timer" onClose={mockOnClose} />
    );
  ...
  it('should call onClose when close button is clicked', async () => {
    ...
    const closeButton = buttons.find(btn => 
      btn.querySelector('svg') || btn.textContent?.includes('Close') || btn.textContent?.includes('X')
    );
  ...
  it('should navigate through steps', async () => {
    ...
    const nextButton = buttons.find(btn => 
      btn.textContent?.includes('Next') || btn.getAttribute('aria-label')?.includes('next')
    );
  ...
  it('should navigate back through steps', async () => {
    ...
    if (nextButton) {
      ...
      const prevButton = updatedButtons.find(btn => 
